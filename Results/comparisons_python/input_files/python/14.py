...
class Node(object):
	"""
	Node contains two objects - a var and a ill child, both may be a Node or both None,
	latter representing a leaf
	"""
	def __init__(self, var=None, ill=None):
	...
	def __str__(self):
		...
		"""
		if self.var is None and self.ill is None:
			return "(   )"
		else:
			return "( " + str(self.var) + " " + str(self.ill) + " )"

	def __eq__(self, other):
		if self.var is None and self.ill is None:
			return 		other.var is 		None and other.ill is None
		elif self.var is None and self.ill 			is None:
			# return False
		else:
			return self.var ==			 other.var and 			self.ill == other.ill
