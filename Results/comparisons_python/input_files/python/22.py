...
inst2 =            data1.loc[data1['instance'] == 'i-2.txt']#comments commentscommentscommentscommentscomments
...
x = np.array(horizon) #comments commentscommentscommentscommentscomments
#comments commentscommentscommentscommentscomments#comments commentscommentscommentscommentscomments
...
for inst in instance:
	for algo in algorithm: #comments commentscommentscommentscommentscomments#comments commentscommentscommentscommentscomments
		alg = inst.loc[inst['algorithm'] == algo]
		y_temp = np.array([])
		for hori in horizon: #comments commentscommentscommentscommentscomments#comments commentscommentscommentscommentscomments
			hor = alg.loc[alg['horizon'] == hori]  #comments commentscommentscommentscommentscomments#comments commentscommentscommentscommentscomments
			y_temp = np.append(y_temp,np.array(hor['REG'].mean(0)))#comments commentscommentscommentscommentscomments
