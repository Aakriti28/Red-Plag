...
def plot_regression_line(x, y, b):  
    var.scatter(x, y, color = "m",marker = "o", s = 30)
    y_pred = b[0] + b[1]*x 
    var.plot(x, y_pred, color = "g") 
    var.ylabel('metric values') 
    var.legend(["best fit line","data points"])
    # var.title("Levitt's Metric of Covid19 in India ")
    var.xlabel('day count') 
    # var.savefig("covid.png")
fields=[]
rows=[]
